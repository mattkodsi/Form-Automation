...
def build_form():
    ...
    s.rect(44,120,300,38,8,"#ffffff",stroke="#c7c9ee"); s.text(58,144,"Riverside Gardens Apartments",14,INK,weight="600"); s.text(330,144,"▾",12,SUB,anchor="end")
    ...
    ya+=gcard(CAX,ya,CW,1,"Property & identifiers",DB,[
        [R("Property name","Riverside Gardens Apartments","db"),R("FHA / Section 8 #","IL00X000000","db")],
        [R("Address","100 Main Street, Wilmette IL 60091","db"),R("Entity type","Limited Partnership","db")],
        [R("Ownership entity","Riverside Gardens Preservation, L.P.","db"),R("Entity address","30 Hudson Yards, 72nd Fl, NY","db")]])+gap
    ...
    field(s,x0,Y+62,inner,"CA organization","Regional Housing Agency","db")
    ...
    field(s,nx,Y+110,nw,"Contact name","Sam Rivera","db")
    ...
    ya+=gcard(CAX,ya,CW,4,"Owner contact & signatory",DB,[
        [R("Owner point of contact","Jordan Doe","db"),R("POC phone · auto-format","(929) 618-8405","db")],
        [R("POC email","jdoe@example.com","db"),R("General Partner","Related (GP)","db")],
        [R("Signatory — name","Alex Morgan","db"),R("Signatory — title","Vice President","db")]])
    colA_end=ya

    # ---------- Column B: 5,6,7,10 ----------
    yb=240
    yb+=gcard(CBX,yb,CW,5,"RCS appraiser",CY,[
        [R("Appraiser name","Taylor Reed","cyc"),R("Firm","Belfry Valuation","cyc")],
        [R("Email","appraiser@example.com","cyc"),R("Phone · auto-format","(708) 500-2380","cyc")]])+gap
    ...
    yb+=gcard(CBX,yb,CW,10,"Tenant notice",("property letterhead","#eef2f6",MUTE),[
        ...
        [R("Sender — name","Jordan Lee","db"),R("Sender — position","Community Manager","db")],
        [R("Comments to (mgmt) · derived","RA Management, 100 Main Street","calc"),R("Copy to CA · derived","NHC, Tucker GA","calc")]])
    colB_end=yb
...
def build_dbm():
    ...
    s.rect(14,112,222,40,8,"#22467a"); s.text(30,132,"Riverside Gardens Apartments",12.5,"#ffffff",weight="700"); s.text(30,146,"IL00X000000 · complete",9.5,"#9db4d6")
    for name,yy,dot in [("Ravenswood Terrace",184,"#e0b23c"),("Sample Property",222,"#e0b23c"),("Lakeside Commons",260,"#3f9a55"),("Harbor Point",298,"#e0b23c"),("Maple Court",336,"#3f9a55"),("Riverview Homes",374,"#c05050")]:
    ...
    s.text(274,100,"Riverside Gardens Apartments",20,INK,weight="700")
    s.text(274,124,"FHA IL00X000000 · 100 Main Street, Wilmette IL · 51 units · senior",12,SUB)
    ...
    # Col 1
    y=200
    y+=dcard(C1X,y,CW,"Identifiers & entity",[("Property name","Riverside Gardens Apartments","Mar '26"),("FHA / Section 8 #","IL00X000000","Mar '26"),("Address","100 Main Street","Mar '26"),("Entity type","Limited Partnership","Mar '26"),("Ownership entity","Riverside Gardens Preservation, L.P.","Mar '26"),("Entity address","30 Hudson Yards, NY","Mar '26")])+gap
    y+=dcard(C1X,y,CW,"Contacts",[("Contract admin","Regional Housing Agency","Mar '26"),("CA contact (prefix + name)","Ms. Sam Rivera","Mar '26"),("CA position","Asset Manager","Mar '26"),("CA address","1975 Lakeside Pkwy, Tucker GA","Mar '26"),("Owner contact","Jordan Doe","Mar '26"),("Owner phone · auto-format","(929) 618-8405","Mar '26"),("Appraiser name","Aaron Zabel","Jan '26"),("Appraiser firm","Belfry Valuation","Jan '26")])
    col1_end=y
    # Col 2
    y=200
    y+=dcard(C2X,y,CW,"Signatories & sender",[("General Partner","Related (GP)","Mar '26"),("Signatory — name","Alex Morgan","Mar '26"),("Signatory — title","Vice President","Mar '26"),("Notice sender — name","Jordan Lee","Feb '26"),("Notice sender — position","Community Manager","Feb '26")])+gap
