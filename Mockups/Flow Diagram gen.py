...
def build():
    ...
    s.text(24,45,"Renewal Package Builder · HUD Section 8 (RCS) — one property (Riverside Gardens) shown end to end",10,"#c3d2e6")
    ...
    fbox(y+78,"FROM DATABASE",PUR,"Riverside Gardens · Ms. Sam Rivera · Alex Morgan, VP","#f3f3fc",PUR)
    ...
    s.rect(x+18,y+70,w-36,26,6,"#e7f5e9"); s.text(x+28,y+87,"Riverside Gardens:  $140,658  <  $178,245  →  PASS",9.5,GRN,weight="700")
