...
def build():
    ...
    s.text(24,80,"Reviewing — Riverside Gardens Apartments",13.5,INK,weight="700")
    ...
    y+=collapsed(s,X,y,CW,2,"Property","Riverside Gardens Apartments · IL00X000000 · 100 Main Street, Wilmette IL · Limited Partnership")+14
    # 3 Owner & signatory (collapsed)
    y+=collapsed(s,X,y,CW,3,"Owner & signatory","Jordan Doe (POC) · Alex Morgan, Vice President · General Partner: Related (GP)")+14
    ...
    y+=collapsed(s,X,y,CW,5,"Appraiser","Taylor Reed · Belfry Valuation · appraiser@example.com · (708) 500-2380",tag="this cycle",tagc=TEAL)+14
    ...
    y+=collapsed(s,X,y,CW,9,"Tenant notice","Jordan Lee, Community Manager · Copy to CA derived from record")+14
