...
- **`app/full-mp/test_browser.js`** — **the only suite that presses keys.** Builds its own bundle,
  ...
  cannot see: they prove `save()` saves, this proves a keystroke *reaches* it. 564 checks — Enter and
...
**2488 checks across thirteen suites** (98 · 200 · 144 · 222 · 131 · 444 · 189 · 564 · 111 · 15 · 91 · 120 · 159) as of 2026-07-30, counted off a real run. These
