...
const MIN_CHECKS=346;   // 2026-07-30: +13 — Tab walks the columns in the order the form is read,
                       // and a dropdown you have landed on says so, with the ring measured.
                       // 2026-07-30: +6 — a fill claimed after a reload has to still be on the form, and the other order (M61).
