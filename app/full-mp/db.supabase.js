...
function makeSupabaseDb(client) {
  ...
  /* A save that carries property.name IS a rename — which is how the twins got
    ...
    listCycles(pid) {
      ...
      setCycleGenerated(cid, docs) { const c = D.cycles[cid]; if (!c) return Promise.resolve(); const at = now(); c.generated = mergeGenerated(c.generated, docs, at); c.updated_at = at; return enqueue('cy' + cid, () => pushCycle(cid)); },
